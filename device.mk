...
# Biometrics
PRODUCT_PACKAGES += \
    android.hardware.biometrics.fingerprint@2.3-service.hormoz

PRODUCT_COPY_FILES += \
    frameworks/native/data/etc/android.hardware.fingerprint.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.hardware.fingerprint.xml

# Camera
$(call soong_config_set,camera,ext_lib,//$(DEVICE_PATH):libcameraservice_extension.hormoz)
...
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/configs/libs/public.libraries.txt:$(TARGET_COPY_OUT_VENDOR)/etc/public.libraries.txt
...
# Lights
PRODUCT_PACKAGES += \
    android.hardware.lights-service.hormoz

# LiveDisplay
PRODUCT_PACKAGES += \
    vendor.lineage.livedisplay-service.hormoz
...
# Power
#$(call soong_config_set,power_libperfmgr,mode_extension_lib, //$(DEVICE_PATH):libperfmgr-ext-hormoz)
...
# Vibrator
PRODUCT_PACKAGES += \
    android.hardware.vibrator-service.hormoz
