...
BOARD_SYSTEM_KERNEL_MODULES := $(addprefix system_dlkm/,$(BOARD_SYSTEM_KERNEL_MODULES_LOAD))
BOARD_VENDOR_KERNEL_MODULES := $(addprefix vendor_dlkm/,$(BOARD_VENDOR_KERNEL_MODULES_LOAD))
BOARD_VENDOR_RAMDISK_KERNEL_MODULES := $(addprefix vendor_ramdisk/,$(ALL_VENDOR_RAMDISK_MODULES))

BOARD_VENDOR_KERNEL_MODULES += \
    $(KERNEL_PATH)/vendor_dlkm/gps_drv_dl_v051.ko \
    $(KERNEL_PATH)/vendor_dlkm/gps_pwr.ko \
    $(KERNEL_PATH)/vendor_dlkm/gps_scp.ko
...
BOARD_PREBUILT_VENDORIMAGE := vendor/daria/hormoz/images/vendor.img
